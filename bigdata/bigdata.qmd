...
My project analyzes a total of 35 French novels from the 19th century. I divided these books into two main datasets: Dataset 1: English Translations (29 books). This includes 19 Realist novels by Émile Zola and 10 Romantic works by Victor Hugo. We use this large group for our main data pipeline. Dataset 2: French Originals (6 books). This is a smaller control group. It includes 3 books by Zola and 3 books by Hugo. We use this group to find translation errors and test specific French algorithms.
