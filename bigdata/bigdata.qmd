...
The FK scores for the English translations range from 64.63 (l_argent) to 81.91 (le_dernier_jour). The full ranking from lowest to highest is: l_argent (64.63), la_debacle (66.93), son_excellence (67.52), la_curee (68.26), au_bonheur (69.8), le_ventre (70.2), la_joie (70.96), la_fortune (71.34), le_reve (71.91), l_oeuvre (71.95), bug_jargal (72.39), la_bete (72.79), le_docteur (73.0), la_conquete (73.16), notre_dame (73.24), claude_gueux (73.58), la_terre (73.4), quatrevingt_treize (74.88), travailleurs (74.92), miserables (75.06), han_d_islande1 (75.06), han_d_islande2 (75.83), pot_bouille (75.9), germinal (77.12), l_assommoir (77.3), une_page (77.74), homme_qui_rit (78.4), la_faute (79.28), le_dernier_jour (81.91).
...
The 6 French originals (Figure 4.3.2) show the same behavior. All curves are parallel and close together, following the ideal slope closely. The French curves are more tightly grouped than the English ones, with less vertical spread between books.
In both datasets, the rank-frequency relationship is consistent across all books regardless of author or literary movement. This confirms that Zipf's Law holds across both languages and both literary schools in this corpus.
...
![](plots/Eng_dialogue.png)
*Table 4.4.1: Average sentence length in English corpus by school and type.*
...
![](plots/fr_dialogue.png)
*Table 4.4.2: Average sentence length in French corpus by school and type.*
